...
Small collection of basic scripts to read and combine Aneufinder data to generate new plots. Especially useful for beginners in R. Scripts should be quite self-explanatory so I haven't included user instructions here.
